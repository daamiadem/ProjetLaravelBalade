      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h5 class="title">{{__(" Create Event")}}</h5>
          </div>
          <div class="card-body">
            ...
            <form action="/evenement/add" method="post" enctype="multipart/form-data">
                         ...
                         <input type="text" name="capacite" class="form-control m-2" placeholder="Capacity">

                         <input type="date" name="date" class="form-control m-2" placeholder="Date of event">
